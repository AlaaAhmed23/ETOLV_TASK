...
class SchoolViewController extends Controller
{
    ...
    protected Client $neo4j;
    public function __construct(\Illuminate\Contracts\Container\Container $app,SchoolService $schoolService)
    {
        $this->schoolService = $schoolService;
        $this->neo4j = $app->make('Neo4jClient');
    }
